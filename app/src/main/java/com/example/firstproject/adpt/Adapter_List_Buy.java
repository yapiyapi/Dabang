...
public class Adapter_List_Buy extends RecyclerView.Adapter<Adapter_List_Buy.CustomViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        ...
        /** 게시물 식별번호 **/
        String 식별번호 = 구매_list.get(position);
        /** Post 객체 **/
