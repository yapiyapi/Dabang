...
public class Adapter_List_SoldOut extends RecyclerView.Adapter<Adapter_List_SoldOut.CustomViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        ...
        /** 게시물 식별번호 **/
        String 식별번호 = 판매완료_list.get(position);
        /** Post 객체 **/
        ...
        holder.메뉴_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                popupMenu.getMenuInflater().inflate(R.menu.sub_menu_soldout, popupMenu.getMenu());
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    @Override
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        //수정
                        if (menuItem.getItemId() == R.id.update_soldout) {
                            //Post activity로 이동
                        ...
                        //판매중
                        else if (menuItem.getItemId() == R.id.sell_soldout) {
                            MainActivity.shared_상태변경(식별번호,"판매",true,holder.itemView.getContext());
                            판매완료_list.remove(식별번호);
                            판매중_list.add(0,식별번호);
                            //새로고침
                            notifyItemRemoved(pos);
                        }
                        //숨김
                        else if (menuItem.getItemId() == R.id.hide_soldout) {
                            MainActivity.shared_상태변경(식별번호,"숨김",true,holder.itemView.getContext());
                            전체_data_arr.remove(식별번호);
                            판매완료_list.remove(식별번호);
                            숨김_list.add(0,식별번호);
                            //새로고침
                            notifyItemRemoved(pos);
                        ...
                        //삭제
                        else if (menuItem.getItemId() == R.id.delete_soldout) {
                            //데이터 삭제
        ...
        public CustomViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    /** 게시물 식별번호 **/
                    String 식별번호 = 판매완료_list.get(posi);
