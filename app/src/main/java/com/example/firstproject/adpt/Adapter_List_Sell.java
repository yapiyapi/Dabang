...
import com.example.firstproject.Activity_TraderChoice;
...
public class Adapter_List_Sell extends RecyclerView.Adapter<Adapter_List_Sell.CustomViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        ...
        /** 게시물 식별번호 **/
        String 식별번호 = 판매중_list.get(position);
        /** Post 객체 **/
        ...
        holder.메뉴_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                popupMenu.getMenuInflater().inflate(R.menu.sub_menu_sell, popupMenu.getMenu());
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        ...
                        //판매완료
                        else if (menuItem.getItemId() == R.id.soldout_sell) {
                            MainActivity.shared_상태변경(식별번호,"판매",false,holder.itemView.getContext());
                            판매중_list.remove(식별번호);
                            판매완료_list.add(0,식별번호);
                            //거래자 확인 Activity 이동
                            Intent intent = new Intent(view.getContext(), Activity_TraderChoice.class);
                        ...
                        //숨김
                        else if (menuItem.getItemId() == R.id.hide_sell) {
                        ...
                        //삭제
                        else if (menuItem.getItemId() == R.id.delete_sell) {
                            //데이터 삭제
